...
namespace Microsoft.Partner.CSP.Api.V1.Samples {
  ...
  public static class Customer {
    ...
    public static string GetCustomerCid(string customerMicrosoftId, string resellerMicrosoftId, string sa_Token) {
      var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("https://api.cp.microsoft.com/customers/get-by-identity?provider=AAD&type=external_group&tid={0}&etid={1}", customerMicrosoftId, resellerMicrosoftId));
    ...
    public static dynamic CreateCustomer(dynamic customer, string resellerCid, string sa_Token) {
      var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("https://api.cp.microsoft.com/{0}/customers/create-reseller-customer", resellerCid));
    ...
    private static dynamic GetCustomer_Token(string customerCid, string ad_Token) {
      var request = (HttpWebRequest)HttpWebRequest.Create(string.Format("https://api.cp.microsoft.com/{0}/tokens", customerCid));
